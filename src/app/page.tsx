...
export default function RegisterForm() {
  ...
  const checkboxIsAgree = (event: React.ChangeEvent<HTMLInputElement>) => {
  ...
  return (
    <div className="mx-auto vstack gap-3" style={{ width: "400px" }}>
      ...
      {/* Extra Items */}
      <div>
        <label className= {"form-label" + (planError ? "is-invalid" : "") }>Extra Item(s)</label>
        <div>
          <input
      ...
      <div>
        <input className="me-2" type="checkbox" onChange={checkboxIsAgree}checked={isUserAgreed}/>I agree to the terms and
        conditions
      </div>
